...
import 'package:abpos/pages/dashboard/metrics_summary_grid.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _SectionHeader(
              title: 'metrics_summary'.tr,
              subtitle: 'metrics_summary_subtitle'.tr,
              trailing: Obx(
                () => _FilterButton(
            ...
            MetricsSummaryGrid(controller: controller),
